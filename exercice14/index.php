...
<body>
    ...
    <div class="container">
        <form action="controller.php" method="post">
            ...
            <div class="champs">
                <textarea name="champ2" id="champ1" cols="50" rows="20"><?php if (isset($_SESSION['champcorec1'])) {
                    foreach ($_SESSION['champcorec1'] as $value) {
                        echo $value."\n";
                    } 
                }?></textarea>    
                <textarea name="champ3" id="champ1" cols="50" rows="20" class="c2"><?php if (isset($_SESSION['champcorec2'])) {
